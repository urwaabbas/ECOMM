  ...
  return (
    <nav className="bg-white border-b border-gray-200 sticky top-0 z-50 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        <Link
          href="/"
          className="text-xl font-black uppercase tracking-wider text-indigo-600"
        >
          HAANLI BAZAAR
        </Link>
        ...
        <div className="flex items-center gap-4 sm:gap-6">
          ...
          <Link
            href="/wishlist"
            className="relative text-sm font-semibold text-gray-700 hover:text-indigo-600 transition"
          >
            Wishlist
            {wishlistCount > 0 ? (
              <span className="ml-1 inline-flex min-w-5 items-center justify-center rounded-full bg-indigo-600 px-1.5 py-0.5 text-[10px] font-bold text-white">
                {wishlistCount}
              </span>
            ) : null}
          </Link>
          ...
          {session?.user ? (
            ...
            <div className="flex items-center gap-4">
              ...
              <Link
                href="/register"
                className="text-sm font-semibold text-white bg-indigo-600 px-4 py-2 rounded-md hover:bg-indigo-700 transition"
              >
                Sign Up
              </Link>
            </div>
