      ...
      <div className="flex-1 p-8 max-w-[1600px] w-full mx-auto space-y-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-0.5">
              ...
              . Here is what's happening with Haanli Bazaar today.
            </p>
          </div>
                ...
                <PieChart>
                  ...
                  <Tooltip
                    contentStyle={{
                      ...
                      boxShadow: "0 4px 6px -1px rgb(0 0_0 / 0.1)",
                    }}
                  />
                  <Legend
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-gray-100 text-left">
                    ...
                    <th className="pb-3 text-xs font-bold text-gray-400 uppercase tracking-wider text-right">
                      Total
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-50">
                  {recentOrders.map((order) => (
                    ...
                    >
                      ...
                      <td className="py-3.5">
                        <span
                          className={`text-xs font-bold px-2.5 py-1 rounded-full ${statusStyle[order.status] || "bg-gray-100 text-gray-700"}`}
                        >
          ...
          <div className="bg-white border border-gray-200/80 rounded-2xl p-6 shadow-xs flex flex-col">
            ...
            <div className="space-y-4 flex-1">
              {lowStockProducts.map((product) => (
                <div
                  key={product._id}
                  className="flex items-center gap-3.5 p-2.5 rounded-xl hover:bg-gray-50 transition border border-gray-100"
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p
                      className={`text-xs font-semibold mt-0.5 ${product.stock === 0 ? "text-[#EF4444]" : "text-amber-500"}`}
                    >
                      {product.stock === 0
                        ? "Out of Stock"
              ...
              <tbody className="divide-y divide-gray-50">
                {recentUsers.map((user) => (
                  <tr key={user._id} className="hover:bg-gray-50/60 transition">
                    ...
                    <td className="py-3.5">
                      <span
                        className={`text-xs font-bold px-2.5 py-1 rounded-full ${user.role === "admin" ? "bg-indigo-100 text-indigo-700" : "bg-gray-100 text-gray-600"}`}
                      >
                    ...
                    <td className="py-3.5">
                      <span
                        className={`text-xs font-bold px-2.5 py-1 rounded-full ${user.isVerified ? "bg-emerald-100 text-[#10B981]" : "bg-red-100 text-[#EF4444]"}`}
                      >
        ...
        <div className="bg-white border border-gray-200/80 rounded-2xl p-6 shadow-xs mb-8">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link
              href="/admin/reviews"
              className="bg-yellow-500 text-white text-sm font-semibold px-5 py-2.5 rounded-xl hover:bg-yellow-600 transition shadow-xs"
            >
              Manage Reviews
            </Link>
          </div>
